...
public class EmployeeTest {
    ...
    public void updateEmployeeTest(){
        ...
        employee.setEmailId("Kameswari@123");

        Employee employeeUpdated =  repo.save(employee);

        Assertions.assertThat(employeeUpdated.getEmailId()).isEqualTo("kameswari@123");
    ...
    public void deleteEmployeeTest(){
        ...
        Optional<Employee> optionalEmployee = repo.findByEmail("kameswari@123");
